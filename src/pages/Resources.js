  ...
  return (
    <>
      <Header
        ...
        headerSubText={"Here's a list of resources to help you land that next, cool dev or engineer role. The list ranges from practice problems, interview tips to inspirational advice. Dig in."}
      />
